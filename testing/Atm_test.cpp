...
TEST_CASE("ATM and BankInternalSystem integration scenario", "[ATM_Integration]") {
    ...
    REQUIRE(display_initial == "500"); // Expecting just the balance string
    ...
    REQUIRE(display_after_deposit == "600"); // Expecting just the balance string
    ...
    REQUIRE(display_final == "450"); // Expecting just the balance string
}